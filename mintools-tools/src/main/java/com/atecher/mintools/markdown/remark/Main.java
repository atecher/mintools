...
public class Main {
    ...
    private static class Args {
        ...
        File output = null;
        boolean html = false;
        com.atecher.mintools.markdown.remark.option.Options options = null;
    }
    ...
    private void printHelp(Options opts) {
        ...
        hf.printHelp("com.atecher.mintools.markdown.remark [options] [-o <outputfile>] <input_file_or_url>", opts);
        System.err.println();
    }
        ...
        if (cl.hasOption('t')) {
            ...
            switch (type) {
                case "markdown":
                    ...
                    break;
                case "multimarkdown":
                    result.options = com.atecher.mintools.markdown.remark.option.Options.multiMarkdown();
                    break;
                case "markdownextra":
                    result.options = com.atecher.mintools.markdown.remark.option.Options.markdownExtra();
                    break;
                case "pegdown":
                    result.options = com.atecher.mintools.markdown.remark.option.Options.pegdownBase();
                    break;
                case "pegdownall":
                    result.options = com.atecher.mintools.markdown.remark.option.Options.pegdownAllExtensions();
                    break;
                case "github":
