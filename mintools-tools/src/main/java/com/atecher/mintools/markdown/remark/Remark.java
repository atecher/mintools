...
package com.atecher.mintools.markdown.remark;


import com.atecher.mintools.markdown.convert.DocumentConverter;
import com.atecher.mintools.markdown.remark.option.Options;
 ...
 * {@code com.atecher.mintools.markdown.convert*} methods on some form of input.</p>
 * <p>
 * <p>Examples:</p>
 * <p>
 * <pre>
 * // Create a generic com.atecher.mintools.markdown.remark that converts to pure-Markdown spec.
 * Remark com.atecher.mintools.markdown.remark = new Remark();
 * String cleanedUp = com.atecher.mintools.markdown.remark.convertFragment(inputString);
 *
 * // Create a com.atecher.mintools.markdown.remark that converts to pegdown with all extensions enabled.
 * Remark pegdownAll = new Remark(Options.pegdownAllExtensions());
 * cleanedUp = pegdownAll.com.atecher.mintools.markdown.convert(new URL("http://www.example.com"), 15000);
 *
 * // stream the conversion
 * pegdownAll.withStream(System.out).com.atecher.mintools.markdown.convert(new URL("http://www.overzealous.com"), 15000);
 * </pre>
 *
...
public class Remark {
    ...
    /**
     * This class is used to handle conversions that com.atecher.mintools.markdown.convert directly to streams.
     */
     ...
     * <p>
     * <p><strong>Note: The com.atecher.mintools.markdown.convert methods on the returned class will always return {@code null}.</strong></p>
     * <p>
     * <p><strong>Note: It is up to the calling class to handle closing the writer!</strong></p>
     * <p>
     * <p>Example:</p>
     * <p>
     * <blockquote>{@code new Remark(options).withWriter(myWiter).com.atecher.mintools.markdown.convert(htmlText);}</blockquote>
     *
     ...
     * <p>Example:</p>
     * <p>
     * <blockquote>{@code new Remark(options).withOutputStream(myOut).com.atecher.mintools.markdown.convert(htmlText);}</blockquote>
     *
    ...
    @SuppressWarnings({"WeakerAccess"})
    public String convert(Document doc) {
        // Note: all com.atecher.mintools.markdown.convert methods should end up going through this method!
