...
<head>
    <meta charset="utf-8"/>
    <title>Markdown在线编辑器-MinTools</title>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/thirdparty/markdown/themes/css/style.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/thirdparty/markdown/css/editormd.css"/>
</head>
<body>
...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="mt-head"><h1>Markdown在线编辑器</h1></div>
...
稿源：[钛媒体](http://www.tmtpost.com/194306.html)</textarea>
            </div>
...
<script src="${pageContext.request.contextPath}/assets/thirdparty/markdown/editormd.js"></script>
<script type="text/javascript">
    ...
    $(function () {
        testEditor = editormd("test-editormd", {
            width: "100%",
            height: 720,
            path: '${pageContext.request.contextPath}/assets/thirdparty/markdown/lib/'
        });
