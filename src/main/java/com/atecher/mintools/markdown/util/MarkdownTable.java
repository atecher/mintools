...
package com.atecher.mintools.markdown.util;

import java.io.PrintWriter;
import java.util.LinkedList;
import java.util.List;

import static com.atecher.mintools.markdown.util.MarkdownTable.Alignment.LEFT;
import static com.atecher.mintools.markdown.util.MarkdownTable.Alignment.RIGHT;
